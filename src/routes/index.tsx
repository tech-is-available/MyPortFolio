...
const TITLE =
  "Geeta Vajaram Choudhari — Networking · Linux · AWS Cloud Portfolio";
...
const PROJECTS = [
  {
    ...
    link: "https://docs.google.com/document/d/1Y5FnTNiVWbhMuVsGpoeZQxMH1kbFSMfsoGXXBh2lbY8/edit?usp=sharing",
  ...
  },
  {
    ...
    link: "https://docs.google.com/document/d/1QoNsR-aj3b35JDLXrVbyGMIkuDRa7-yqtj0xtyS01pg/edit?usp=sharing",
    linkType: "documentation",
  },
  {
    icon: Cloud,
    ...
    link: "https://docs.google.com/document/d/1j_pGZDDpjYHACnokfiImOtA1EjgcWoHedym1Hoiqg0M/edit?usp=sharing",
    linkType: "documentation",
  },
  {
    icon: Database,
    ...
    link: "https://github.com/tech-is-available/CloudShare",
    linkType: "github",
  },
];
...
const SERVICES = [
  {
    icon: Network,
    t: "Basic Network Configuration & Troubleshooting",
  },
  {
    icon: Terminal,
    t: "Linux / RHEL Server Administration",
  },
  {
    icon: Cloud,
    t: "AWS Cloud Setup & Fundamentals",
  },
  {
    icon: Server,
    t: "Cloud Resource Configuration",
  },
  {
    icon: MessageSquare,
    t: "Technical Support",
...
const EDUCATION = [
  ...
  {
    degree: "HSC — Science",
    school: "S.I.C.E.S. College, Ambernath",
    year: "2023",
  },
  {
    degree: "SSC",
    school: "New English High School, Badlapur",
    year: "2021",
  },
];
...
const ROADMAP = [
  {
    t: "Networking",
    d: "CCNA foundations, routing & switching",
    icon: Network,
  },
  {
    t: "Linux / RHEL",
    d: "Server administration & automation",
    icon: Terminal,
  },
  {
    t: "AWS Cloud",
    d: "Compute, storage, identity, networking",
    icon: Cloud,
  },
  {
    t: "DevOps",
    d: "CI/CD, containers, infrastructure as code",
    icon: Cpu,
  },
  {
    t: "Cloud & Infrastructure Engineer",
    d: "Long-term career goal",
    icon: Rocket,
  },
];
...
const LINKEDIN =
  "https://www.linkedin.com/in/geeta-chaudhari-28b939274/";
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          ...
          >
            ...
            <span className="hidden sm:inline">
              Geeta<span className="text-gradient">.</span>
            </span>
          </a>
      ...
      <main className="relative">
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[1.15fr_0.85fr]">
            <Reveal>
              ...
              <p className="mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
                Building my career in Networking, Linux, and Cloud Computing.
                I am a motivated fresher with knowledge of network
                configuration, Linux administration, and AWS cloud services.
                I am continuously improving my technical skills and building a
                strong foundation, with DevOps as a future career goal.
              </p>
        ...
        <section id="about" className="relative px-5 py-20">
          <div className="mx-auto max-w-6xl">
            <SectionHeading
              eyebrow="About"
              title="Curious about infrastructure, serious about growth"
            />

            <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
              <Reveal className="glass glass-hover rounded-3xl p-8">
                <p className="text-muted-foreground">
                  I&apos;m a Computer Science graduate from Mumbai, Maharashtra,
                  interested in networking, Linux, and cloud computing. My
                  training at NetTech India has helped me develop a solid
                  foundation in CCNA networking, Red Hat Linux administration,
                  and AWS cloud services. I&apos;m continuously enhancing my
                  technical skills and aim to pursue DevOps as a future career
                  path.
                </p>
              ...
              >
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  My career journey, step by step.
                </p>

                <ol className="mt-6 space-y-4">
                  {["CCNA", "Linux / RHEL", "AWS", "DevOps (Future)"].map(
                    (s, i) => (
              ...
              <Reveal className="glass rounded-3xl p-8">
                <ul className="space-y-4 text-sm">
                  {[
                    ...
                    {
                      icon: Github,
                      label: "github.com/tech-is-available",
                      href: GITHUB,
                    },
                    {
                      icon: Linkedin,
        ...
        <section className="relative px-5 py-20">
          <Reveal className="glass mx-auto max-w-4xl rounded-3xl p-10 text-center glow-ring">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
              ...
              Networking, Linux, AWS Cloud, IT Infrastructure and DevOps.
            </p>
